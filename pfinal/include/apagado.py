...
def apagado():        #Se declara una funcion con cero argumentos
    GPIO.output(4, False) #El pin se enciende cuando el segundo argumento es True, si se desea apagar se pone False
    print("pin 4 apagado")
